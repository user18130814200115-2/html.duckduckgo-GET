...
$pattern4 = '/\/\/duckduckgo.com\/favicon.ico/i';
$pattern5 = '/DuckDuckGo/';
...
$lines_string=preg_replace($pattern4, "logo.ico", $lines_string);
$lines_string=preg_replace($pattern5, "WesterDigitalSearch", $lines_string);
...
.logo_homepage {
	background: no-repeat center/100% url("logo.svg"),linear-gradient(transparent, transparent) !important;
	background-size: contain !important;
}
.header__logo-wrap {
	background: no-repeat center/auto 36px url("logo.svg"),linear-gradient(transparent, transparent) !important;
	background-size: contain !important;
}
</style>
